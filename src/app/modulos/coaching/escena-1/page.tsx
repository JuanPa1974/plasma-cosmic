...
export default function VideoScenePage() {
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-6">
                <Link
                    href="/modulos/coaching"
                    className="inline-flex items-center text-gray-500 hover:text-goya-blue transition-colors text-sm font-medium"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-black rounded-xl overflow-hidden shadow-2xl aspect-video relative group">
                        ...
                        <div className="absolute inset-0 w-full h-full">
                            <iframe
                                ...
                                src="https://www.youtube.com/embed/qbT896tkq-w"
                                title="M01 C01 E01 Coaching — Introducción y Contexto"
                                frameBorder="0"
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                        <h3 className="font-bold text-gray-500 text-xs uppercase tracking-wider mb-4">
                            Siguiente Capítulo
                        </h3>
                        ...
                        <div className="group cursor-pointer">
                            ...
                            <h4 className="font-bold text-gray-800 group-hover:text-goya-blue transition-colors">
                                Escena 2: Feedback efectivo
                            </h4>
